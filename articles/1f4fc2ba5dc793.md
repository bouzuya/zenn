...
title: "axum crate の Router (2) 設定済みの Router はどう動くのか"
topics: ["rust"]
type: "tech"
---

[前回は axum crate の Router (1) で Router の route メソッドなどを見ました](https://zenn.dev/doctormate/articles/7ccac91c3773d5)。 なんとなく `Router` の内部構造をつかみはじめたところです。
...
<https://docs.rs/axum/0.8.6/axum/struct.Router.html#impl-Service%3CIncomingStream%3C'_,+L%3E%3E-for-Router>
...
<https://docs.rs/axum/0.8.6/axum/struct.Router.html#impl-Service%3CRequest%3CB%3E%3E-for-Router>
