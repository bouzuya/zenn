...
title: "axum crate の Router はどう動くのか"
topics: ["rust"]
type: "tech"
---

# axum crate の Router はどう動くのか

[前回は axum crate を学び直しの第 2 回で Router の route メソッドなどを見ました](https://zenn.dev/doctormate/articles/7ccac91c3773d5)。 なんとなく `Router` の内部構造をつかみはじめたところです。
