...
title: "axum crate の Router (4) Router::merge と nest"
topics: ["rust"]
type: "tech"
---
...
含まれるルートを `Router::merge` はフラットに統合し、 `Router::nest` は入れ子の形に統合します。
...
<https://docs.rs/axum/0.8.6/axum/struct.Router.html#method.merge>
...
<https://docs.rs/axum/0.8.6/src/axum/routing/mod.rs.html#252-300>
...
<https://github.com/tokio-rs/axum/blob/axum-v0.8.6/axum/src/routing/path_router.rs#L162-L204>
...
<https://docs.rs/axum/0.8.6/axum/struct.Router.html#method.nest>
...
<https://docs.rs/axum/0.8.6/src/axum/routing/mod.rs.html#209-231>
...
<https://github.com/tokio-rs/axum/blob/axum-v0.8.6/axum/src/routing/path_router.rs#L206-L244>

`Router::merge` と同様に `self.route()` していくのですが、 `path_for_nested_route` でパスを書き換えています。

<https://github.com/tokio-rs/axum/blob/axum-v0.8.6/axum/src/routing/path_router.rs#L535-L546>
